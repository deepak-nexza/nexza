            ...
            <div class="auto-container">
                <div class="inner-container clearfix">
                    <div class="copyright-text">
                        <p>Â© Copyright 2019 All Rights Reserved by <a href="index.html">Expert-Themes</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="modalLRForm" style="margin-top:50px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
            ...
            <div class="modal-body mb-1">
              ...
              <div class="text-center mt-2">
                <a href="#" class="reply-btn theme-btn btn-style-one"><span class="btn-title">Login</span></a>
              </div>
            </div>
            <!--Footer-->
            <div class="modal-footer">
              ...
              <a href="#" class="reply-btn theme-btn btn-style-one"><span class="btn-title">Close</span></a>
            </div>
