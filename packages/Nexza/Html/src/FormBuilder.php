...
use Nexza\Html\Exceptions\EncryptException;
use Nexza\Html\Exceptions\DecryptException;
use Nexza\Html\Exceptions\EncodingException;
use Nexza\Html\Exceptions\DecodingException;
...
class FormBuilder extends BaseFormBuilder
{
     ...
     * @param string $data
     * @return string
     * @throws Nexza\Html\Exceptions\EncodingException
     */
     ...
     * @param string $data
     * @return string
     * @throws Nexza\Html\Exceptions\DecodingException
     */
     ...
     * @param mixed $data
     * @return string
     * @throws Nexza\Html\Exceptions\EncryptException
     */
    protected function encrypt($data)
    {
        try {
            $value = \Scramble::encrypt($this->encode($data));
    ...
    {
        try {
            $value = $this->decode(\Scramble::decrypt($data));
            return $value;
    ...
    {
        $this->protectedFields = array_pull($options, $this->formProtectKey, ['_token' => csrf_token()]);
